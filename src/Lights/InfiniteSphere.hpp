...
public:
    InfinteSphere(const std::shared_ptr<BitMapTexture<Spectrum>> emssision, const mat4& toWorld) : _emission(emssision), _toWorld(toWorld), _toLocal(glm::transpose(toWorld)) {}
