...
public:
    ...
    static Spectrum
    connectCameraBDPT(const Scene& scene, Sampler& sampler, const LightPath& lightPath, const LightPath& cameraPath, int l, ivec2& pixel);

    static Spectrum
                 connectLightBDPT(const Scene& scene, Sampler& sampler, const LightPath& lightPath, const LightPath& cameraPath, int c, Float lightPdf);
    static Float misWeight(const LightPath& lightPath, int l, const LightPath& cameraPath, int c, const Distribution1D& lightDistr, const std::map<const Light*, size_t>& map);

    static Spectrum connectBDPT(const Scene& scene, const LightPath& lightPath, int l, const LightPath& cameraPath, int c);
