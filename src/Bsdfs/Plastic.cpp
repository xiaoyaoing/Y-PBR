...
RoughPlastic::RoughPlastic(const std::shared_ptr<Texture<Spectrum>>&      diffuseReflectance,
                           const std::shared_ptr<Texture<Spectrum>>&      specularReflectance,
                           Float                                          mIor,
                           ...
                           const std::shared_ptr<Texture<Float>>&         mURoughness) : BSDF(BXDFType(BSDF_GLOSSY | BSDF_REFLECTION | BSDF_DIFFUSE)),
