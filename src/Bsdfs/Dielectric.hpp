...
public:
    RoughDielectric(Float _ior, std::shared_ptr<MicrofacetDistribution> distrib, std::shared_ptr<Texture<Float>> roughness, std::shared_ptr<Texture<Float>> uroughness = nullptr, std::shared_ptr<Texture<Float>> vroughness = nullptr);
